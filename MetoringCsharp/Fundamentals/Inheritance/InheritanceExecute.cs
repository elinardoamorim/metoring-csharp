...
namespace MetoringCsharp.Fundamentals.Inheritance
{
    public class InheritanceExecute
    {
        ...
        {
            Person student = new Student(name: "Ruan", cpf: "062.856.754-05", birthdate: new DateOnly(1995, 11, 29), registration: 256389);
            Person teacher = new Teacher(name: "Rogerio", cpf: "075.689.741-05", birthdate: new DateOnly(1990, 12, 29), salary: 6000.00M, subjet: "Mentoria C#");
            Person employee = new Employee(name: "Cristiano", cpf: "051.362.758-75", birthdate: new DateOnly(1989, 10, 11),
